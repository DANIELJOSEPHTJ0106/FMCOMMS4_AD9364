...
architecture behav of fsk_scrambler is 
    ...
    signal current_scramble_bit : STD_LOGIC_VECTOR (0 downto 0) := "0";
    ...
    signal in_pkt_data_V_reg_240 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_block_state1_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state2_pp0_stage0_iter1 : BOOLEAN;
    signal regslice_both_out_stream_V_data_V_U_apdone_blk : STD_LOGIC;
    signal ap_block_state3_pp0_stage0_iter2 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal in_pkt_keep_V_reg_246 : STD_LOGIC_VECTOR (0 downto 0);
    signal in_pkt_strb_V_reg_251 : STD_LOGIC_VECTOR (0 downto 0);
    signal in_pkt_user_V_reg_256 : STD_LOGIC_VECTOR (12 downto 0);
    signal in_pkt_last_V_reg_261 : STD_LOGIC_VECTOR (0 downto 0);
    signal in_pkt_id_V_reg_266 : STD_LOGIC_VECTOR (0 downto 0);
    signal in_pkt_dest_V_reg_271 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal or_ln_fu_195_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal icmp_ln39_fu_153_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal trunc_ln49_fu_191_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal trunc_ln56_fu_213_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_1_fu_222_p4 : STD_LOGIC_VECTOR (6 downto 0);
    signal scrambled_bit_fu_216_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component fsk_scrambler_regslice_both IS
    generic (
        DataWidth : INTEGER );
    port (
        ap_clk : IN STD_LOGIC;
...
begin
    regslice_both_in_stream_V_data_V_U : component fsk_scrambler_regslice_both
    generic map (
        DataWidth => 8)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_stream_V_keep_V_U : component fsk_scrambler_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_stream_V_strb_V_U : component fsk_scrambler_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_stream_V_user_V_U : component fsk_scrambler_regslice_both
    generic map (
        DataWidth => 13)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_stream_V_last_V_U : component fsk_scrambler_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_stream_V_id_V_U : component fsk_scrambler_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_stream_V_dest_V_U : component fsk_scrambler_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_stream_V_data_V_U : component fsk_scrambler_regslice_both
    generic map (
        DataWidth => 8)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_stream_V_keep_V_U : component fsk_scrambler_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_stream_V_strb_V_U : component fsk_scrambler_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_stream_V_user_V_U : component fsk_scrambler_regslice_both
    generic map (
        DataWidth => 13)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_stream_V_last_V_U : component fsk_scrambler_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_stream_V_id_V_U : component fsk_scrambler_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_stream_V_dest_V_U : component fsk_scrambler_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln39_fu_153_p2 = ap_const_lv1_1))) then
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, regslice_both_out_stream_V_data_V_U_apdone_blk, in_stream_TVALID_int_regslice, out_stream_TREADY_int_regslice)
    begin
                ap_block_pp0_stage0_01001 <= (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and ((regslice_both_out_stream_V_data_V_U_apdone_blk = ap_const_logic_1) or (out_stream_TREADY_int_regslice = ap_const_logic_0))) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (out_stream_TREADY_int_regslice = ap_const_logic_0)) or ((ap_const_logic_1 = ap_const_logic_1) and (in_stream_TVALID_int_regslice = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, regslice_both_out_stream_V_data_V_U_apdone_blk, in_stream_TVALID_int_regslice, out_stream_TREADY_int_regslice)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and ((regslice_both_out_stream_V_data_V_U_apdone_blk = ap_const_logic_1) or (out_stream_TREADY_int_regslice = ap_const_logic_0))) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (out_stream_TREADY_int_regslice = ap_const_logic_0)) or ((ap_const_logic_1 = ap_const_logic_1) and (in_stream_TVALID_int_regslice = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, regslice_both_out_stream_V_data_V_U_apdone_blk, in_stream_TVALID_int_regslice, out_stream_TREADY_int_regslice)
    begin
                ap_block_pp0_stage0_subdone <= (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and ((regslice_both_out_stream_V_data_V_U_apdone_blk = ap_const_logic_1) or (out_stream_TREADY_int_regslice = ap_const_logic_0))) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (out_stream_TREADY_int_regslice = ap_const_logic_0)) or ((ap_const_logic_1 = ap_const_logic_1) and (in_stream_TVALID_int_regslice = ap_const_logic_0)));
    end process;
    ...
    feedback_fu_179_p2 <= (tmp_fu_163_p3 xor tmp_2_fu_171_p3);
    icmp_ln39_fu_153_p2 <= "1" when (in_stream_TUSER_int_regslice = ap_const_lv13_0) else "0";
    ...
    or_ln_fu_195_p3 <= (trunc_ln49_fu_191_p1 & feedback_fu_179_p2);
    ...
    out_stream_TDATA_int_regslice <= (tmp_1_fu_222_p4 & scrambled_bit_fu_216_p2);
    ...
    scrambled_bit_fu_216_p2 <= (trunc_ln56_fu_213_p1 xor current_scramble_bit);
    tmp_1_fu_222_p4 <= in_pkt_data_V_reg_240(7 downto 1);
    tmp_2_fu_171_p3 <= lfsr(6 downto 6);
    tmp_fu_163_p3 <= lfsr(3 downto 3);
    trunc_ln49_fu_191_p1 <= lfsr(6 - 1 downto 0);
    trunc_ln56_fu_213_p1 <= in_pkt_data_V_reg_240(1 - 1 downto 0);
end behav;
