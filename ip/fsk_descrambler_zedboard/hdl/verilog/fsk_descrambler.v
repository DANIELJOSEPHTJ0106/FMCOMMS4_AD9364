...
wire   [6:0] or_ln_fu_185_p3;
reg    ap_block_pp0_stage0_01001;
wire   [0:0] tmp_2_fu_167_p3;
wire   [0:0] tmp_fu_159_p3;
wire   [5:0] trunc_ln42_fu_181_p1;
wire   [0:0] feedback_fu_175_p2;
wire   [0:0] trunc_ln47_fu_199_p1;
wire   [6:0] tmp_1_fu_209_p4;
wire   [0:0] recovered_bit_fu_203_p2;
reg   [0:0] ap_NS_fsm;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_enable_reg_pp0_iter1 == 1'b1) & ((regslice_both_out_stream_V_data_V_U_apdone_blk == 1'b1) | (out_stream_TREADY_int_regslice == 1'b0))) | ((1'b1 == 1'b1) & ((out_stream_TREADY_int_regslice == 1'b0) | (in_stream_TVALID_int_regslice == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter1 == 1'b1) & ((regslice_both_out_stream_V_data_V_U_apdone_blk == 1'b1) | (out_stream_TREADY_int_regslice == 1'b0))) | ((1'b1 == 1'b1) & ((out_stream_TREADY_int_regslice == 1'b0) | (in_stream_TVALID_int_regslice == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter1 == 1'b1) & ((regslice_both_out_stream_V_data_V_U_apdone_blk == 1'b1) | (out_stream_TREADY_int_regslice == 1'b0))) | ((1'b1 == 1'b1) & ((out_stream_TREADY_int_regslice == 1'b0) | (in_stream_TVALID_int_regslice == 1'b0))));
end
...
assign feedback_fu_175_p2 = (tmp_fu_159_p3 ^ tmp_2_fu_167_p3);

assign in_stream_TREADY = regslice_both_in_stream_V_data_V_U_ack_in;

assign or_ln_fu_185_p3 = {{trunc_ln42_fu_181_p1}, {feedback_fu_175_p2}};

assign out_stream_TDATA_int_regslice = {{tmp_1_fu_209_p4}, {recovered_bit_fu_203_p2}};

assign out_stream_TVALID = regslice_both_out_stream_V_data_V_U_vld_out;

assign recovered_bit_fu_203_p2 = (trunc_ln47_fu_199_p1 ^ feedback_fu_175_p2);

assign tmp_1_fu_209_p4 = {{in_stream_TDATA_int_regslice[7:1]}};

assign tmp_2_fu_167_p3 = lfsr[32'd6];

assign tmp_fu_159_p3 = lfsr[32'd3];

assign trunc_ln42_fu_181_p1 = lfsr[5:0];

assign trunc_ln47_fu_199_p1 = in_stream_TDATA_int_regslice[0:0];


reg find_kernel_block = 0;
// synthesis translate_off
`include "fsk_descrambler_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //fsk_descrambler
