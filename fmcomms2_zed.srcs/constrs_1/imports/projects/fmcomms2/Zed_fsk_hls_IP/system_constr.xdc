...
# ==============================================================================
# AD9364 Control Pins (CTRL_IN 0, 1, 2, and 3)
# Mapping: AD9364 -> FMCOMMS4 P201 -> ZedBoard Zynq Pins
# ==============================================================================
set_property -dict {PACKAGE_PIN A19 IOSTANDARD LVCMOS25} [get_ports {fmcomms4_ctrl_in_0[0]}]
set_property -dict {PACKAGE_PIN D22 IOSTANDARD LVCMOS25} [get_ports {fmcomms4_ctrl_in_0[1]}]
set_property -dict {PACKAGE_PIN C22 IOSTANDARD LVCMOS25} [get_ports {fmcomms4_ctrl_in_0[2]}]
#set_property -dict {PACKAGE_PIN A18 IOSTANDARD LVCMOS25} [get_ports {fmcomms4_ctrl_in_0[3]}]
